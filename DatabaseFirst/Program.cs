...
namespace DatabaseFirst
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Khởi tạo context
            using (var context = new QuanLySinhVienContext())
            {
                ...
                {
                    Console.WriteLine($"Tên: {sv.Ten}, Tuổi: {sv.Tuoi}, LopID: {sv.LopId}, Khoa: {sv.Lop.Khoa.TenKhoa}");
                }
                ...
                foreach (var sinhVien in sinhViensCNTT)
                {
                    ...
                    {
                        Console.WriteLine($"{i++}: Tên: {sinhVien.Ten}, Tuổi: {sinhVien.Tuoi}, Lớp: {sinhVien.Lop.TenLop}, Khoa: {sinhVien.Lop.Khoa.TenKhoa}");
                    }
                }
            }
        }
